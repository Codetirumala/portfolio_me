          ...
          {education.map((edu, i) => (
            <AnimatedSection key={edu.degree} delay={i * 0.15}>
              <motion.div
                ...
                className="pro-card rounded-2xl p-6 sm:p-8 group"
              >
                <div className="flex flex-col sm:flex-row gap-6 items-start">
                  {/* Icon */}
                  <div
                    className="w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center text-3xl shrink-0 group-hover:scale-110 transition-transform"
                  >
                    {edu.icon}
                  </div>
